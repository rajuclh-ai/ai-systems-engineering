...
![Input form](pr_review_agent/assets/screenshot_input.png)

**2. Three specialist agents run in parallel — each with token count and duration**

![Results — verdict and agent cards](pr_review_agent/assets/screenshot_results.png)

**3. Critic synthesizes all findings — deduplicated, ranked by severity**

![Critic findings table](pr_review_agent/assets/screenshot_findings.png)
